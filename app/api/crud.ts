...
export const getPokemons: any = async (search: string | number, sort: string = 'name', order: string = 'asc', page: number = 1) => {
    const url = `http://217.210.173.199:3004/pokemons?_page=${page}&_sort=${sort}&_order=${order}`;
    const urlSearch = `http://217.210.173.199:3004/pokemons?_page=${page}&_sort=${sort}&_order=${order}&${Number(search) ? `id=${search}` : `name_like=${search}`}`;
...
export const getPokemon: any = async (id: number) => {
    const url = `http://217.210.173.199:3004/pokemons/${id}`;
...
export const addPokemon: any = async (data: any) => {
    const url = "http://217.210.173.199:3004/pokemons";
...
export const addLike: any = async (pokemon_id: any, userId: number) => {
    const url = "http://217.210.173.199:3004/likes";
...
export const deleteLike: any = async (id: any) => {
    const url = `http://217.210.173.199:3004/likes/${id}`;
...
export const getLikes: any = async (userId: number) => {
    const url = `http://217.210.173.199:3004/likes?user_id=${userId}`;
...
export const getNotification: any = async () => {
    const url = `http://217.210.173.199:3004/notification`;
...
export const deleteNotification: any = async (userId: number) => {
    const url = `http://217.210.173.199:3004/notification/${userId}`;
...
export const getLike: any = async (userId: number, pokemonId: number) => {
    const url = `http://217.210.173.199:3004/likes?user_id=${userId}&pokemon_id=${pokemonId}`;
